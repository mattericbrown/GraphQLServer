export const REDIS_SESSION_PREFIX = "redSess:";
export const USER_SESSION_PREFIX = "userSess:";

export const FORGOT_PASSWORD_PREFIX = "forPass:";
...
//     POST_TITLE_NOT_LONG: "title should be at least 10 characters",
//     POST_DETAILS_NOT_LONG: "details should be at least 20 characters",
